...
function dimhouse_register_acf_fields() {
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array('key' => 'field_dimhouse_page_post_header_tab', 'label' => 'Page/Post Header', 'name' => '', 'type' => 'tab', 'placement' => 'top'),
			array('key' => 'field_dimhouse_page_post_header_enabled', 'label' => 'Enable Page/Post Header', 'name' => 'page_post_header_enabled', 'type' => 'true_false', 'default_value' => 1, 'ui' => 1, 'instructions' => 'Header nay chi hien thi tren page va post, khong hien thi homepage.'),
			array('key' => 'field_dimhouse_page_post_header_logo', 'label' => 'Page/Post Header Logo', 'name' => 'page_post_header_logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'instructions' => 'Logo rieng cho header page/post. Bo trong de dung uploads/banner/baner/logo.jpg.'),
			array('key' => 'field_dimhouse_page_post_header_logo_url', 'label' => 'Header Logo URL', 'name' => 'page_post_header_logo_url', 'type' => 'url', 'instructions' => 'Bo trong de link ve trang chu.'),
			array(
				'key' => 'field_dimhouse_page_post_header_menu_items',
				'label' => 'Header Menu Items',
				'name' => 'page_post_header_menu_items',
				'type' => 'repeater',
				'layout' => 'row',
				'button_label' => 'Add Header Menu Item',
				'sub_fields' => array(
					array('key' => 'field_dimhouse_page_post_header_menu_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text'),
					array('key' => 'field_dimhouse_page_post_header_menu_url', 'label' => 'URL', 'name' => 'url', 'type' => 'url'),
					array('key' => 'field_dimhouse_page_post_header_menu_new_tab', 'label' => 'Open in new tab', 'name' => 'new_tab', 'type' => 'true_false', 'default_value' => 0, 'ui' => 1),
				),
			),
			array('key' => 'field_dimhouse_general_options_tab', 'label' => 'General Options', 'name' => '', 'type' => 'tab', 'placement' => 'top'),
